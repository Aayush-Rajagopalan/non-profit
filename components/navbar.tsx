                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    {navigation.map((item, index) => (
                      <Link key={index} href="/" className="w-full px-4 py-2 -ml-4 text-zinc-500 rounded-md dark:text-zinc-300 hover:text-blue-500 focus:text-blue-500 focus:bg-blue-100 dark:focus:bg-zinc-800 focus:outline-none">
                          {item}
                      </Link>
                    ))}
          ...
          <ul className="items-center justify-end flex-1 pt-6 list-none lg:pt-0 lg:flex">
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link href="/" className="inline-block px-4 py-2 text-lg font-normal text-zinc-800 no-underline rounded-md dark:text-zinc-200 hover:text-blue-500 focus:text-blue-500 focus:bg-blue-100 focus:outline-none dark:focus:bg-zinc-800">
                    {menu}
                </Link>
              </li>
            ))}
